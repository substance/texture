...
class Author extends AbstractWriter {
  ...
  _renderContentPanel($$) {
    ...
    const ArticleComponent = this.componentRegistry.get('article', 'strict')
    const Overlay = this.componentRegistry.get('overlay', 'strict')
    const ContextMenu = this.componentRegistry.get('context-menu', 'strict')
